...
var get0016Info = function(bleDeviceId, callback) {
  ...
  let vehicleMode
  let random
  sendApdu(1, ["00A40000023f00", "0084000008", "00A40000020016", "00B095002B"], bleDeviceId, (code, data) => {
    console.log(data)
    if (code == 0) {
...
var set0016Info = function(cardInfo, bleDeviceId, callback) {
  command = "00D60000" + num2hex(parseInt(cardInfo.length / 2), 1, true);
  sendApdu(1, ["00A40000023f00", "00A40000020016", command], bleDeviceId, callback)
}
