...
var loadCardInit = function (credit, terminnalNo, pinCode, procType, keyIndex, bleDeviceId, callback) {
  ...
  let macCos = "805000" + procType + "0B" + keyIndex + DataUtil.num2hex(credit, 4, true) + terminnalNo+"10"
  sendApdu(1, ["00A40000021001", "00B095002b", macCos], bleDeviceId, (code, data) => {
    if (code == 0) {
...
var getVehiclePara = function (bleDeviceId, callback){
  ...
  sendApdu(1, ["00A40000021001", "00B095002b"], bleDeviceId, (code, data1) => {
    if (code == 0 && data1[1].slice(-4) == "9000") {
      ...
      sendApdu(2, ["00A40000023f00", "00B0810B08", "00A4000002df01","0084000004"], bleDeviceId, (code, data) => {
