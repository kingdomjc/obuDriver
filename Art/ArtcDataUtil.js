...
var ArtcDataUtil = {
  ...
  reTLV: reTLV,
  makeC0SendData: makeC0SendData,
  makeC1SendData: makeC1SendData,
  makeC2SendData: makeC2SendData,
  makeC3SendData: makeC3SendData,
  makeC4SendData: makeC4SendData,
  makeC5SendData: makeC5SendData,
  makeCCSendData: makeCCSendData,
  makeCDSendData: makeCDSendData,
  makeCFSendData: makeCFSendData,
}
